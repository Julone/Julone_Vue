<template>
  <el-form ref="form" class="form container"  label-width="80px" >
    <div class="usericon userIconBorder" v-if="imgUpdate" :style="{background: `url(${getUserIcon}) center center/cover no-repeat` }">
        <input type="file" id="userIcon" @change="changeHead">
        <div class="comIcon cam">&#xe6f0;</div>
      </div>
    ...
    <el-form-item label="性别">
      ...
      <el-date-picker v-model.lazy="userData.userBorn" format="yyyy 年 MM 月 dd 日" default-value="1996-01-01" @change="onSubmit" clearable editable size="small" type="date" placeholder="选择日期">
      </el-date-picker>
    </el-form-item>
      ...
      <myfooter style="margin-top:60px"></myfooter>
  </el-form>
              ...
              cancelButtonText: '取消',
                ...
                data: {
                  ...
                  if(res.data.code == 200){
                    this.$message({
                      type: 'success',
                      message: '密码修改成功,请重新登录!',center:true
                    });
                    this.$store.dispatch('logOut');
                    this.$router.push('/login');
                  }else{
